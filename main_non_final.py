...
if __name__ == "__main__":
    ...
    #
    # cutoff_dist = np.mean(dm) * len(dm) / 8000 #kolik zvolit?
    # amount_of_classes_div = div_plot_get_clusters(data, 1000, cutoff_dist)
    ...
    while diff or diff_bin != 0: # Zajistí správný výsledek kmeans, viz komentář u prvního použití kmeans
    ...
    plot_rosenblatt(data, clusters, 100)
    plot_const_incr(data, clusters, 100, 0.1)

    # Neuronová síť
    # Trénování SGD
    perceptron_sgd = Perceptron(2, 3)
