            ...
            if i != j:
                ...
                while k < len(clusters[i]):
                    ...
                    if A1 > A2:
                        ...
                        print("Aktualizovaná J_hodnota: ", improved_J, ", hodnoty s (počet bodů jednotlivých shluků): ", s)
                        diff += 1
                    k += 1
    if J_1 == improved_J:
        print("J hodnota se nezměnila, rozdělení již bylo optimální. Vykresluji výsledek...")
    else :
        print("J hodnota se změnila z ", J_1, " na ", improved_J, ". Doseženo optimálního rozdělení, vykresluji výsledek...")
